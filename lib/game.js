...
function generateLillypads() {
  ...
  for (var i = 0; i < 5; i++) {
    var lillypads = new Lillypad(x, 25, 80, 30);
...
function generateTurtles() {
  ...
  for (var i = 0; i < 6; i++) {
    var turtles = new Turtle(x, 65, 80, 30, 4);
...
function generateLogs() {
  ...
  for (var i = 0; i < 6; i++) {
    ...
    var logs = new Log(x, 110, 85, 30, 3);
...
function generateRightTrucks() {
  ...
  for (var i = 0; i < 4; i++) {
    var trucks = new Truck(x, 335, 100, 40, 3);
...
function generateLeftCars() {
  ...
  for (var i = 0; i < 4; i++) {
    var cars = new Car(x, 245, 100, 40, 3);
